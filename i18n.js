...
const T18 = {
  en: {
    ...
    n_events:'Events', n_transport:'Transport', n_plan:'Plan Trip',
  ...
  it: {
    ...
    n_events:'Eventi', n_transport:'Trasporti', n_plan:'Pianifica',
  ...
  de: {
    ...
    n_events:'Veranstaltungen', n_transport:'Anreise', n_plan:'Reise Planen',
  ...
  fr: {
    ...
    n_events:'Événements', n_transport:'Transport', n_plan:'Planifier',
